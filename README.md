...
The objective of this project was to investigate key factors associated with the risk of an SDWA violation posing acute health risks and analyze [state-wise trends](https://plotly.com/~prashankpm/1/). 
